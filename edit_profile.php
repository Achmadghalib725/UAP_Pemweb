...
// ... (SEMUA LOGIKA PHP TETAP SAMA SEPERTI SEBELUMNYA) ...
// ... (Tidak ada perubahan di bagian logika PHP di atas) ...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {

    // --- A. Logika untuk Update Profil (Nama) ---
    ...
    // --- C. Logika untuk Upload Foto Profil ---
        ...
        if ($check !== false && $_FILES["profile_picture"]["size"] < 2000000 && in_array($imageFileType, $allowed_types)) {
            if (move_uploaded_file($_FILES["profile_picture"]["tmp_name"], $target_file)) {
                ...
                if(mysqli_query($conn, $update_pic_query)) {
                    $message_success = "Foto profil berhasil diunggah.";
                } else {
                    $error_message = "Gagal menyimpan path gambar ke database.";
                }
            } else {
                $error_message = "Maaf, terjadi kesalahan saat mengunggah file.";
            }
        } else {
            $error_message = "File bukan gambar yang valid (jpg, png, gif) atau ukurannya terlalu besar (maks 2MB).";
        }
    }
}
...
<div class="page-header">
    ...
    <div class="page-actions">
        <a href="dashboard.php" class="btn-secondary">&lsaquo; Kembali ke Dashboard</a>
    </div>
</div>
...
<div class="profile-container">
    <div class="profile-picture-section">
        <h4>Foto Profil</h4>
        <img src="uploads/<?php echo htmlspecialchars($user['profile_picture'] ? $user['profile_picture'] : 'default.png'); ?>" alt="Foto Profil" class="profile-pic">
